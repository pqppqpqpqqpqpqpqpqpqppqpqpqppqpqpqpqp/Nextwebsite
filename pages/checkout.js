...
const Checkout = ({ cart, addToCart, removeFromCart, subTotal }) => {
  return (
    <div className='container sm:m-auto px-2'>
      ...
      <h1 className='font-bold text-xl my-8 text-center capitalize'>checkout</h1>
      <h2 className='capitalize font-semibold text-xl'>1.delivary details</h2>
      ...
      <h2 className='capitalize font-semibold text-xl'>2. Review Cart Items & Pay</h2>


      <div className=' sideCart right-0 bg-pink-100 m-2 p-8 z-10'>
      ...
      <Link href={'/checkout'}>
         ...
         <button className="flex mr-2  text-white bg-red-500 border-0 py-2 px-1 focus:outline-none hover:bg-pink-600 rounded text-lg capitalize"><BsFillBagCheckFill className='m-1'/> Pay ₹{subTotal}</button>
       </Link>
      </div>
